                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                    ...
                                    ${order.cart.customer.shippingAddress.houseNo}, ${order.cart.customer.shippingAddress.streetNo}
                                <br/>
                                   ${order.cart.customer.shippingAddress.landmark}, ${order.cart.customer.shippingAddress.province}
                                <br/>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                    <strong>Billing Address</strong><br/>
                                       ${order.cart.customer.billingAddress.houseNo}, ${order.cart.customer.billingAddress.streetNo}
                                    <br/>
                                        ${order.cart.customer.billingAddress.landmark}, ${order.cart.customer.billingAddress.province}
                                    <br/>
